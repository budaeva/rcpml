...
{	
	public void testBuildTree01() throws Exception {
		...
		Document doc = XML.loadDocument( new InputStreamReader(Utils.openScript("/scripts/test_script_2.xml", TestsPlugin.getDefault().getBundle())), "/scripts/test_script_2.xml");
