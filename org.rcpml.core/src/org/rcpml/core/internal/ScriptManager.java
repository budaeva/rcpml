...
public class ScriptManager {
	...
	private static void loadLanguages() {
		...
		IConfigurationElement[] conf = Platform.getExtensionRegistry().getConfigurationElementsFor(SCRIPT_EXT_POINT);
	...
	static IScriptingLanguage getScriptingLanguage(String language) {
		...
		if(!(lang instanceof IScriptingLanguage)) {
			try {
				lang = ((IConfigurationElement)lang).createExecutableExtension(CLASS_ATTR);
